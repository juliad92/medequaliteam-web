  ...
  return (
    <section className="relative flex min-h-[calc(100svh-7rem)] items-end overflow-hidden bg-[var(--charcoal)] lg:min-h-[88vh]">
      ...
      <div className="relative z-10 mx-auto grid w-full max-w-7xl grid-cols-1 items-end gap-10 px-4 pt-28 pb-16 sm:px-8 sm:pb-20 lg:grid-cols-2 lg:gap-16 lg:pt-0">
        ...
        >
          <p className="mb-5 flex items-center gap-3 text-[13px] font-medium tracking-[0.16em] text-[var(--green-light)] uppercase">
        ...
        >
          <div className="rounded-2xl border border-white/10 bg-white/6 p-6 backdrop-blur-sm sm:p-8">
            <p className="mb-4 flex items-center gap-2 text-[12px] font-medium tracking-[0.18em] text-[var(--green-light)] uppercase">
            ...
            <Link
              ...
              className="group inline-flex items-center gap-1.5 text-[15px] font-medium text-[var(--green-light)] transition-colors hover:text-white"
            >
              {t.hero.learnMore}
